...
$result = mysqli_query($connect,"SELECT seances.idseance,themes.nom, seances.DateSeance  FROM seances JOIN themes ON themes.idtheme=seances.Idtheme WHERE DateSeance<'$date'");
...
echo "<select name='menuChoixseanceselect' required>";// permet de créer la liste déroulante
...
echo "<INPUT type='submit' value='Notez cette séance'>";
echo "</FORM>";
echo "</div>";
